...
public class ProperNameSearchService implements SearchService{
	...
	public boolean search(String pathFile) {
		...
		for(String baseUrl:listUrls){
			SearchServiceWorker worker=new SearchServiceWorker(baseUrl, SearchConstants.PROPERNAME_PATTERN,
					SearchConstants.PROPERNAME_FOLDER);
			worker.start();
