...
public class TwitterAccountSearchService implements SearchService{
	...
	public boolean search(String pathFile) {
		...
		for(String baseUrl:listUrls){
			SearchServiceWorker worker=new SearchServiceWorker(baseUrl, SearchConstants.TWITTERACCOUNT_PATTERN,
					SearchConstants.TWITTERACCOUNT_FOLDER);
			worker.start();
